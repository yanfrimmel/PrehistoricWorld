...
HASKELL_LIB_NAME_WINDOWS := libAI.dll.a
...
HASKELL_LIB_WINDOWS := $(GHC_WIN) -O2 -shared -fPIC -o $(HASKELL_LIB_NAME_WINDOWS) ../src/haskell/*.hs  ../src/hsbracket.c -L"/home/yan/.wine/drive_c/Program Files/Haskell Platform/8.6.3/lib/rts/libHSrts_thr.a"-lHSrts_thr-ghc8.6.3
