...
HASKELL_LIB_NAME_WINDOWS := libAI.dll.so
...
HASKELL_LIB_WINDOWS := $(GHC_WIN) -O2 -dynamic -shared -fPIC -cpp -o $(HASKELL_LIB_NAME_WINDOWS) ../src/haskell/*.hs  ../src/hsbracket.c -lHSrts_thr-ghc8.0.2
